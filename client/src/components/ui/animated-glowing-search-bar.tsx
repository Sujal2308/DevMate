      ...
      <div id="poda" className="relative flex items-center justify-center group w-full">
        ...
        <div id="main" className="relative group w-full">
          <input 
            ...
            type="text" 
            name="text" 
            className="bg-[#010201] border-none w-full h-[56px] rounded-lg text-white px-[59px] text-lg focus:outline-none placeholder-gray-400" 
            value={value}
            onChange={onChange}
            onFocus={onFocus}
            onBlur={onBlur}
          ...
          {value && (
            <div id="filter-icon" className="absolute top-2 right-2 flex items-center justify-center z-[2] max-h-10 max-w-[38px] h-full w-full [isolation:isolate] overflow-hidden rounded-lg bg-gradient-to-b from-[#161329] via-black to-[#1d1b4b] border border-transparent">
              <button
                type="button"
                onClick={clearSearch}
                className="text-white hover:text-red-400 transition-colors text-2xl p-1"
