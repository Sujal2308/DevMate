        ...
        {post.repoUrl && (
          <div className="mb-4">
            <a 
              ...
              className="group block bg-[#0d0d17] border border-x-border/30 rounded-xl overflow-hidden hover:border-x-blue/50 transition-all duration-300 shadow-lg hover:shadow-x-blue/5"
            >
              <div className="p-4 sm:p-5 flex items-center justify-between bg-gradient-to-r from-x-dark/40 to-transparent">
                <div className="flex items-center space-x-4">
                  <div className="bg-[#161b22] p-2.5 rounded-xl border border-x-border/20 group-hover:scale-110 transition-transform">
                    <svg className="w-6 h-6 text-x-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <h4 className="text-x-white font-bold text-sm sm:text-base group-hover:text-x-blue transition-colors truncate max-w-[200px] sm:max-w-md">
                      {post.repoTitle || post.repoUrl.split('/').slice(-2).join('/')}
                    </h4>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="hidden sm:flex items-center space-x-1.5 px-3 py-1 bg-x-dark/40 border border-x-border/20 rounded-full">
                    <span className="w-2 h-2 rounded-full bg-x-blue"></span>
                    <span className="text-[10px] text-x-gray font-bold uppercase tracking-wider">GitHub</span>
                  </div>
                  <svg className="w-5 h-5 text-x-gray group-hover:text-x-blue transform group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
