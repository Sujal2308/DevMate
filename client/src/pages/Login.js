...
const Login = () => {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-x-black via-x-dark to-x-black flex items-center justify-center py-4 px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Background Effects */}
