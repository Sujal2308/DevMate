...
const Home = () => {
  return (    <div className="min-h-screen bg-x-black text-x-white">
      {/* Hero Section */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen py-20">
            ...
            <div className="flex-1 lg:pr-12 text-center lg:text-left">
              ...
              <p className="text-xl lg:text-2xl text-x-gray mb-8 max-w-2xl">
                ...
                <div className="space-y-6">
                  ...
                  <div className="x-card transform rotate-2 hover:rotate-0 transition-transform duration-300 animate-float">
                    ...
                    <div className="bg-x-darker rounded-lg p-3">
                      <pre className="text-x-blue text-sm">{`const useLocalStorage = (key, initial) => {
