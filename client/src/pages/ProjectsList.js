...
const ProjectsList = () => {
  ...
  return (
    <div className="w-full mx-auto pt-0 pb-8 px-0 sm:px-4">
      {/* Header Card */}
      <div className="bg-gradient-to-br from-x-dark/95 to-x-dark/70 backdrop-blur-sm border border-x-border/50 pt-8 pb-6 px-4 md:px-6 relative rounded-none mb-8">
