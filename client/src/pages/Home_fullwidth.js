    ...
    <div className="min-h-screen bg-x-black text-x-white flex flex-col">
      ...
      <div className="relative flex-1 pt-20 pb-12 overflow-visible flex items-center">
        ...
        <div className="relative w-full">
          <div className="flex flex-col lg:flex-row items-center justify-between py-10 lg:py-16 gap-8 lg:gap-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            {/* Left Content */}
            <div className="flex-1 lg:pr-8 text-center lg:text-left order-2 lg:order-1">
