...
const Home = () => {
  return (
    <div className="min-h-screen bg-x-black text-x-white flex flex-col">
      {/* Hero Section */}
      <div className="relative flex-1 pt-20 pb-12 overflow-visible flex items-center">
        {/* Background Pattern */}
        <div className="absolute inset-0 bg-gradient-to-br from-x-blue/5 to-x-black"></div>

        <div className="relative w-full">
          <div className="flex flex-col lg:flex-row items-center justify-between py-10 lg:py-16 gap-8 lg:gap-12 px-4 sm:px-6 lg:px-8">
            {/* Left Content */}
            <div className="flex-1 lg:pr-8 text-center lg:text-left order-2 lg:order-1 max-w-2xl lg:max-w-none">
              ...
              <p className="text-lg lg:text-xl text-x-gray mb-8 max-w-xl mx-auto lg:mx-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center">
                <Link
                  to="/register"
                  className="bg-x-blue hover:bg-x-blue-hover text-white font-bold text-lg px-10 py-4 rounded-full transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl min-w-[200px]"
                >
                  Get Started Free
                </Link>
                <Link
                  to="/login"
                  className="border-2 border-x-blue text-x-blue hover:bg-x-blue hover:text-white font-bold text-lg px-10 py-4 rounded-full transition-all duration-200 transform hover:scale-105 min-w-[200px]"
                >
                  Sign In
                </Link>
              </div>
  ...
  // Magic happens here ✨
      ...
      <div className="border-t border-x-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <Link
            to="/register"
            className="bg-x-blue hover:bg-x-blue-hover text-white font-bold text-lg px-10 py-4 rounded-full transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl inline-block min-w-[220px]"
          >
            Create Your Account
          </Link>
        </div>
